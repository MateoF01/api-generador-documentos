...
// Tu JSON gigante
  const contenidoArchivo = fs.readFileSync('dataMediana.json', 'utf-8');

  const jsonGigante = JSON.parse(contenidoArchivo);
  ...
  jsonGigante.body.rutaCarpeta = `${jsonGigante.employer.Cuit}/${fechaFormateada}`
